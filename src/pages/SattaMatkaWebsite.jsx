...
const SattaMatkaWebsite = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-orange-200 to-orange-100">
      ...
      {/* Service Description */}
  <div style="margin: 8px; margin-top: 8px; background-color: #fed7aa; border: 2px solid #ef4444; border-radius: 8px; padding: 12px; font-size: 14px; text-align: center; font-family: sans-serif; box-shadow: 0 2px 6px rgba(0,0,0,0.1); line-height: 1.6;">
